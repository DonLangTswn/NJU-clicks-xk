...
> 上次更新 README：2026.8.27
>
> 🎓2026.8: 新朋友们好呀～！作者今年已从 NJU 毕业，很高兴看见还有人在使用我数年前写的脚本，但是受限于毕业生的身份，决定终止对此脚本的维护，因此如果您**有意愿和能力维护和更新本仓库，可联系作者哦!**
>
> ❌2025.8.25：**发现小土豆插件在选课时会报错**，因此`clicks-potato.py`似乎不可用了，建议暂时使用不依赖小土豆插件的`clicks-no-potato.py`
